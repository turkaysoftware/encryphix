...
namespace Encryphix{
    public partial class Encryphix : Form{
        public Encryphix(){ InitializeComponent(); CheckForIllegalCrossThreadCalls = false; }
        // GLOBAL VARIABLES
        // ======================================================================================================
        ...
        private void RunSoftwareEngine(){
            ...
            BtnShowPassword.Height = TextBox_Password.Height;
            BtnSavePath.Height = TextBox_SaveFolder.Height;
        ...
        private void Theme_engine(int ts){
            try{
                ...
                if (theme == 1){
                    ...
                    //
                    TSImageRenderer(BtnSelect, Properties.Resources.ct_folder_light, 25, ContentAlignment.MiddleLeft);
                    TSImageRenderer(BtnBurner, p_mode ? Properties.Resources.ct_decrypt_light : Properties.Resources.ct_encrypt_light, 25, ContentAlignment.MiddleLeft);
                }else if (theme == 0){
                    // SETTINGS
                    ...
                    //
                    TSImageRenderer(BtnSelect, Properties.Resources.ct_folder_dark, 25, ContentAlignment.MiddleLeft);
                    TSImageRenderer(BtnBurner, p_mode ? Properties.Resources.ct_decrypt_dark : Properties.Resources.ct_encrypt_dark, 25, ContentAlignment.MiddleLeft);
                }
                // HEADER
